...
class Sprite:
    ...
    def load_spritesheet(self):
        ...
        for image_index in range(self.image_count):
            image_surface = pygame.Surface(self.image_rect.size,pygame.SRCALPHA).convert_alpha() #pygame.SRCALPHA--  ki chatgpt wie bringe ich den schwarzen kasten weg
    ...
    def draw(self, screen: pygame.Surface, xpos:float, ypos: float, frame_counter):
